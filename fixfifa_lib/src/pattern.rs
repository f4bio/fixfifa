...
pub const ALT_TAB: [BYTE; 54] = [
  ...
  0x48, 0x8B, 0x87, 0xC0, 0x97, 0x00, 0x00,
  // mov rcx, qword ptr ds:[rax+0x1288]
  0x48, 0x8B, 0x88, 0x88, 0x12, 0x00, 0x00,
  // cmp dword ptr ds:[rcx+0xF00], 0x0
  ...
  // lea rdx, ds:[0x0000000145370370]
  0x48, 0x8D, 0x15, 0x9E, 0x2A, 0x9C, 0x01,
  // call 0x000000014147E100
...
pub const ALT_TAB_MASK: [BYTE; ALT_TAB_T] = [
  ...
  0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78,
  0x78, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78,
  0x78, 0x2D, 0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78,
  0x78, 0x78,
];

pub const SHORT_JMP_EQ_REL_OP_T: usize = 2;
pub const SHORT_JMP_EQ_REL_TARGET_T: usize = 4;
pub const SHORT_JMP_EQ_REL_T: usize =
  SHORT_JMP_EQ_REL_OP_T + SHORT_JMP_EQ_REL_TARGET_T;
...
pub const LEAVE_MASK: [BYTE; LEAVE_T] = [
  // 0x2D --> match required
  // 0x78 --> ignore
  0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D,
  0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D, 0x2D,
  0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D,
  0x2D, 0x2D, 0x2D, 0x2D, 0x78, 0x78, 0x78, 0x78, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D,
];

pub const LEAVE_TYPE_OFFSET: usize = 23;
pub const LEA_QWORD_PTR_DS_OP_T: usize = 3;
pub const LEA_QWORD_PTR_DS_CONSTANT_T: usize = 4;
pub const LEA_QWORD_PTR_DS_T: usize =
  LEA_QWORD_PTR_DS_OP_T + LEA_QWORD_PTR_DS_CONSTANT_T;
