...
const GLOBAL_DATA_URL: &str = "https://s3.eu-central-1.amazonaws.com/fixfifa/globals.json";
...
impl GlobalData {
    pub fn new() -> Self {
        ...
        let deserialized: GlobalData = serde_json::from_str(text_resp.as_str()).unwrap();
...
impl State {
    ...
    pub fn new() -> Self {
        ...
        State { team0: Club::new(), team1: Club::new() }
    }
}
